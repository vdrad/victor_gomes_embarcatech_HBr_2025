...
#include "include/mqtt_comm/mqt_comm.h"    // Header file com as declarações locais
...
// Configura as informações de conexão do cliente
    struct mqtt_connect_client_info_t ci = {
        .client_id   = "bitdog1",  // ID do cliente
        .client_user = "aluno",     // Usuário (opcional)
        .client_pass = "senha123"      // Senha (opcional)
    };
